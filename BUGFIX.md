...
(function() {
  ...
  function initFullscreenInterview() {
    const btnFullscreen = document.getElementById('btn-fullscreen-interview');
    if (btnFullscreen) {
      btnFullscreen.addEventListener('click', () => {
        window.location.href = 'interview-fullscreen.html';
      });
    }
  }
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initFullscreenInterview);
  } else {
    initFullscreenInterview();
  }
})();
